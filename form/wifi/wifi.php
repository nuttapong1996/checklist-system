        ...
        <div class="row mt-5"> 
            ...
            <div class="col-sm-5 ">
                <div class="card" >
                        ...
                        <form id="form-check" action="index.php?" method="post">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">                              
                                <li class="list-group-item">
                                    <div class="card-title"> <h5>วันที่และเวลาที่ตรวจเช็ค <i class="fa fa-calendar"></i></h5></div>
                                ...
                                <li class="list-group-item" style="background-color:#FEF9E7;">                                    
                                    ...
                                    <div class="input-group mb-3 input-group-sm">
                                        ...
                                        <span class="form-control form-control-sm " ><i class="fa fa-check" style="color:green;"></i> ใช้ได้ปกติ</span>
                                    </div>                                            
                                    <div class="input-group mb-3 input-group-sm">
